export const teamMembers = [
    ...
    },
    {
        ...
        bio: 'Chartered accountant , Bachelor of Commerce in 2001, with more than 23 years of experience in the labor market Obtained the Egyptian Society of Accountants and Auditors (ESAA) certificate in October 2013. Former Financial Manager of Toric Company (First for Real Estate Development) owned by the New Urban Communities Authority.\nFormer Financial Manager of the Egyptian Transportation Company.\nFormer Financial Advisor at Hazem Hassan Office .',
    },
    // {
    ...
    // },
    {
        ...
        bio: 'Waleed holds a master\'s degree in taxation and general accounting. He is a taxation expert, senior consultant, and a member of the legislative council in the Egyptian ministry of finance. With many years of experience, Waleed has provided Consultation to many companies across multinational and local organizations with their different accounting & Tax challenges. Waleed is also consulting Accounting managers and CFOs in management of the formulation and administration of the tax evaluation and settlement aligned with the government law.',
    },
    {
        name: 'Bassem El said',
        role: 'Head of Construction',
        image: '/assets/images/Bassem.png',
        bio: 'Civil engineer with more than 12 years of experience in construction and finishing works. In the field of contracting and building materials trading he is leading 3 companies from 10 years making successful stories in national and private projects as a main contractor delivering high-quality solutions in architecture and structural design, interiors, MEP (Mechanical, Electrical, Plumbing), and construction management. With a passion for innovation, creativity, and attention to detail, he is dedicated to transforming our visions into reality.',
    },
    {
        name: 'Wael Hassan',
